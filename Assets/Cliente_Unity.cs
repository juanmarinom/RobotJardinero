...
public class Cliente_Unity : MonoBehaviour
{
    ...
    public string Envio_Vrep(string PosObjetivo)
    {   //Pos objetivo con formato 000-000-000 donde los tres difitos definen X-Y-Altura
        ...
        if (bytes > 0)
        {
            ...
            //xBaseRobot = System.Convert.ToInt32(posicionFinal[0]);
            //yBaseRobot = System.Convert.ToInt32(posicionFinal[1]);
            ////cy.text = "Y:     " + posicionFinal[1];

            return PosFinal;
        }
        else return "fallo al enviar";
    }
    //Tipos de peticiones: 
